...
async def doc(bot, update):    
    prefix = await AbidAbdullah199.get_prefix(update.message.chat.id)
    suffix = await AbidAbdullah199.get_suffix(update.message.chat.id)
    ...
    media = getattr(file, file.media.value)
    c_caption = await AbidAbdullah199.get_caption(update.message.chat.id)
    c_thumb = await AbidAbdullah199.get_thumbnail(update.message.chat.id)
